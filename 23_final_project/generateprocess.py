# This file looks for new olders inside user upload and converts them to reel if they are not already converted 
import os,time
    ...
    while True:
        ...
        for folder in folders:
            if(folder not in done_folders):
                ...
                create_reel(folder)    # Convert the image and audio mp3 inside the folder to a reel
