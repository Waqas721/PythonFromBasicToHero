# Class: Class is a blueprint or a template Eg Form for an Exam that contains name,age,ekectives ,father name etc

# Object : Specific instance created from the template ( class) Eg Form which cotains the data for John Doe
